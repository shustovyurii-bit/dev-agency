...
const guarantees = [
  {
    ...
    category: "Аналитика и контроль",
    text: "Еженедельные отчёты и постоянный доступ к аналитике. Вы всегда знаете, куда идут деньги и какой результат они приносят.",
    bg: "bg-brand-50",
  ...
  },
  {
    ...
    text: "Обсуждаем стоимость заранее и строго придерживаемся договорённостей. Никаких скрытых платежей и неожиданных расходов.",
    bg: "bg-sky-50",
    color: "text-sky-500",
  },
  {
    ...
    text: "Один контакт для всех вопросов — никаких перекидываний между отделами. Ваш менеджер всегда на связи в рабочие часы.",
    bg: "bg-indigo-50",
    color: "text-indigo-500",
  },
  {
    emoji: "⚡",
    title: "Старт за 48 часов",
    category: "Скорость запуска",
    text: "Запускаем первые кампании уже через 48 часов после подписания договора. Время — деньги, и мы это понимаем.",
    bg: "bg-amber-50",
